...
\begin{flushleft}
	...
	% TODO: Подберите такую величину отступа, чтобы подпись была выровнена по центру (ручной подбор требуется из-за невозможности использовать \hfill в math mode)
	Тема $\underset{\text{(полное название выпускной квалификационной работы)}}{\text{\dotuline{Разработка инструмента для генерации нагрузки с заданными планом выполнения}}} $ \\ \dotuline{размером выборки для PostgreSQL}$ $\dotuline{\hfill}\\
